...
export const translations = {
  'zh-CN': {
    ...
    saveRules: '保存规则',
    savingRules: '保存中...',
    saveRulesSuccess: '规则保存成功！',
    saveRulesFailed: '保存规则失败',
    saveRulesEmpty: '请先选择规则或添加自定义规则',
    ...
    customSubInfo: '自定义订阅信息',
    customSubInfoPlaceholder: 'upload=0; download=0; total=10737418240; expire=1735689600',
    customSubInfoTooltip: '设置 subscription-userinfo 响应头，客户端会显示流量和到期信息',
    copyExample: '复制示例',
    byteConverter: '流量字节换算器',
    copyBytes: '复制字节',
  ...
  'en-US': {
    ...
    savingRules: 'Saving...',
    saveRulesSuccess: 'Rules saved successfully!',
    saveRulesFailed: 'Failed to save rules',
    saveRulesEmpty: 'Please select rules or add custom rules first',
    ...
    customSubInfo: 'Custom Subscription Info',
    customSubInfoPlaceholder: 'upload=0; download=0; total=10737418240; expire=1735689600',
    customSubInfoTooltip: 'Set subscription-userinfo response header for client to display traffic and expiry info',
    copyExample: 'Copy Example',
    byteConverter: 'Traffic Byte Converter',
  ...
  'fa': {
    ...
    balanced: 'متعادل',
    comprehensive: 'جامع',
    savedRules: 'ذخیره شده',
    saveRules: 'ذخیره قوانین',
    savingRules: 'در حال ذخیره...',
    saveRulesSuccess: 'قوانین با موفقیت ذخیره شد!',
    saveRulesFailed: 'ذخیره قوانین ناموفق بود',
    saveRulesEmpty: 'لطفاً ابتدا قوانین را انتخاب کنید یا قوانین سفارشی اضافه کنید',
    ...
    customSubInfo: 'اطلاعات اشتراک سفارشی',
    customSubInfoPlaceholder: 'upload=0; download=0; total=10737418240; expire=1735689600',
    customSubInfoTooltip: 'تنظیم هدر subscription-userinfo برای نمایش ترافیک و تاریخ انقضا در کلاینت',
    copyExample: 'کپی نمونه',
    byteConverter: 'مبدل بایت ترافیک',
    copyBytes: 'کپی بایت‌ها',
  ...
  'ru': {
    ...
    savedRules: 'Сохранённые',
    saveRules: 'Сохранить правила',
    savingRules: 'Сохранение...',
    saveRulesSuccess: 'Правила успешно сохранены!',
    saveRulesFailed: 'Не удалось сохранить правила',
    saveRulesEmpty: 'Сначала выберите или добавьте правила',
    ...
    customSubInfo: 'Информация о подписке',
    customSubInfoPlaceholder: 'upload=0; download=0; total=10737418240; expire=1735689600',
    customSubInfoTooltip: 'Установить заголовок subscription-userinfo для отображения трафика и срока действия в клиенте',
    copyExample: 'Копировать пример',
    byteConverter: 'Конвертер байтов трафика',
    copyBytes: 'Копировать байты',
